...
- Honey Puff es una mascota virtual sencilla e interactiva pensada para niños y adolescentes. El usuario podrá escoger una mascota, ponerle nombre y cuidarla realizando diferentes acciones como alimentarla, bañarla, ponerla a dormir y jugar con ella. Todo el progreso se guardará en una base de datos usando MongoDB, para tratar de que la información no se pierda.
La idea principal del proyecto es crear una experiencia divertida y tranquila, con imágenes estáticas y funciones fáciles de usar, para que cualquier persona pueda entender cómo funciona desde el primer momento. También queremos que la mascota tenga necesidades básicas como vida, energía, hambre y sueño, para que el usuario tenga que cuidarla constantemente y así se sienta más real e interactiva.
...
<img width="200" height="200" alt="image" src="https://github.com/user-attachments/assets/44cad778-af89-4592-a15e-a3ee6fb9eaeb" />
